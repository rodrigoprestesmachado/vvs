...
### 6. UnconditionalIfStatement (Bloco de if não condicional)

A regra é bem simples, te avisa de um bloco de if que não é condicional, ou seja, tem sempre apenas o valor true ou false apenas.
